    ...
    <div class="mx-auto w-full container p-4 sm:p-6">
        <div class="md:flex md:justify-between">
          ...
          <div class="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <Link to="/contact" class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Contact</Link>
                  
              </div>
              <div>
                  <Link to="/website" class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">More</Link>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-white sm:text-center ">© 2023 <a href="https://hathibrand.in/" class="hover:underline">Hathibrand</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0 justify-center">
              <a href="https://www.facebook.com/hathibrandagarbatti" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank"
            rel="noreferrer">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
                  <span class="sr-only">Facebook page</span>
              </a>
              <a href="https://www.instagram.com/hathibrandagarbatti/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank"
            rel="noreferrer">
              ...
              <a href="https://wa.me/+919638857089" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank"
            rel="noreferrer">
