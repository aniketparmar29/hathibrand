import { GET_PRODUCT_FAILURE, GET_PRODUCT_REQUEST, GET_PRODUCT_SUCCESS,GET_SINGLE_FAILURE,GET_SINGLE_SUCCESS,GET_SINGLE_REQUEST } from "./actionTypes"
...
export const getProducts = () => {
    return (dispatch) => {
        ...
        axios.get(`https://real-cyan-swallow-boot.cyclic.app/products`).then((res)=>{
...
export const getsingle = (id) => {
    return (dispatch) => {
        ...
        axios.get(`https://real-cyan-swallow-boot.cyclic.app/products/${id}`).then((res)=>{
